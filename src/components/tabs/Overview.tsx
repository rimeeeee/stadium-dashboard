  ...
  return (
    <div className="h-full overflow-auto space-y-2 sm:space-y-3">
      <div className="flex items-center justify-between">
        <h2 className="text-sm sm:text-base lg:text-lg font-bold text-gray-900">전체 운영 현황</h2>
        <div className="flex items-center gap-2">
          <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
          <span className="text-xs text-gray-600">실시간 AI 분석중</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3">
        <div className="bg-white rounded-lg p-2 sm:p-3 border border-gray-200 shadow-sm">
          <div className="flex items-center justify-between mb-1 sm:mb-2">
            <h3 className="text-xs font-medium text-gray-600">총 관중</h3>
          ...
          <div className="space-y-1">
            ...
            <div className={`inline-flex items-center px-1 py-0.5 rounded-full text-xs font-medium ${statusInfo.color} ${statusInfo.bgColor}`}>
        ...
        <div className="bg-white rounded-lg p-2 sm:p-3 border border-gray-200 shadow-sm">
          <div className="flex items-center justify-between mb-1 sm:mb-2">
            <h3 className="text-xs font-medium text-gray-600">총 배치 인력</h3>
          ...
          <div className="space-y-1">
            ...
            {staffShortage > 0 && (
              <div className="inline-flex items-center px-1 py-0.5 rounded-full text-xs font-medium text-orange-600 bg-orange-100">
                {staffShortage}명 부족
              </div>
            )}
          </div>
        ...
        <div className="bg-white rounded-lg p-2 sm:p-3 border border-gray-200 shadow-sm">
          <div className="flex items-center justify-between mb-1 sm:mb-2">
            <h3 className="text-xs font-medium text-gray-600">평균 혼잡도</h3>
        ...
        <div className="bg-white rounded-lg p-2 sm:p-3 border border-gray-200 shadow-sm">
          <div className="flex items-center justify-between mb-1 sm:mb-2">
            <h3 className="text-xs font-medium text-gray-600">주의 구역</h3>
      ...
      {/* 야구장 구역도 */}
      <div className="bg-white rounded-lg p-2 sm:p-3 border border-gray-200 shadow-sm">
        <h3 className="text-sm sm:text-base font-semibold text-gray-900 mb-2 sm:mb-3">야구장 구역도</h3>
      ...
      {selectedZone && (
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-2 sm:p-3">
          <h4 className="font-semibold text-blue-900 mb-2 sm:mb-3 text-sm">선택된 구역 정보</h4>
          {zones
            .filter(zone => zone.id === selectedZone)
            .map(zone => (
              <div key={zone.id} className="space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-blue-800 font-medium text-sm">{zone.name}</span>
